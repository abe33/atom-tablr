...
class CSVEditorFormElement extends HTMLElement {
  ...
  static content () {
    ...
    const radiosOnly = (params = {}) => {
      ...
      this.div({class: `control-group with-radios-only radios ${name}`}, () => {
    ...
    const radiosWithTextEditor = (params = {}) => {
      ...
      this.div({class: `control-group with-text-editor radios ${name}`}, () => {
    ...
    const select = (params = {}) => {
      ...
      this.div({class: `control-group select ${name}`}, () => {
        this.div({class: 'controls'}, () => {
          this.label({class: 'setting-title'}, label)
          this.select({
      ...
      this.div({class: 'split-panel'}, () => {
        ...
        this.div({class: 'panel'}, () => {
          ...
          this.div({class: 'control-group boolean skip-empty-lines'}, () => {
            ...
            this.input({type: 'checkbox', name: 'skip-empty-lines', id: `skip-empty-lines-${id}`})
          })
        })
      })
